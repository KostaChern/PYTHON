...
s = 60     
print(f"Петя, Катя и Сережа сделали всего {s} журавликов")

Serj = int(s/6)  # сделал Сережа  
Pit = Serj     # сделал Петя 

Katy = 2*(Pit + Serj) # сделала Катя
print(f"Петя сделал {Pit}, Катя сделала {Katy}, а Сергей сделал {Serj} журавликов")
